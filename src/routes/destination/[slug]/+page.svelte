...
<svelte:head>
    <title>{data.name} - Wisata GTTG NTB 2024</title>
</svelte:head>
...
<div class="min-h-[100vh] lg:w-1/2 lg:border-x mx-auto bg-white">
    <header class="p-4">
        <div class="flex flex-row gap-4 items-center">
            ...
            <h1 class="font-bold grow">Wisata</h1>
        </div>
    </header>
    <div class="p-4">
        <div class="mb-4">
            {#await import(`../../../lib/images/destination/${data.cover}.png`) then { default: src }}
        ...
        <div>
            ...
            <p class="mt-3 text-sm text-justify text-gray-700">{data.description}</p>
        </div>
    </div>
</div>
